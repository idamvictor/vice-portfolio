              ...
              {testimonials.map((_, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    index === currentIndex ? "bg-blue-500 dark:bg-primary" : "bg-gray-300 dark:bg-muted-foreground/30",
                  )}
                />
              ))}
            </div>
...
export default function TestimonialCarouselDemo() {
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-3xl font-bold text-center mb-8">Testimonial Carousel</h1>
      <div className="max-w-2xl mx-auto">
        <TestimonialCarousel testimonials={TESTIMONIAL_DATA} className="mb-16" />
      </div>
    </div>
  )
}

// Export component and types for reuse
